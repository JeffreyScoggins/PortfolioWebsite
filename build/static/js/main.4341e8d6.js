...
var projects=[{title:"Owl Accounting",subtitle:"MEAN Stack",description:"Fully functional accounting software built with user experience in mind",image:"./project-1.gif"//link: "",
},{title:"React Tracks",subtitle:"React and Python",description:"Shopify Clone built in React with a Python backend.",image:"./project-2.gif"//link: "",
},{title:"Clover Customer Server",subtitle:"Angular frontend with a node.js backend with express.js routing",description:"Fully functional restaurant POS with REST API and OAuth application tokens utilized to submit secure payment",image:"./project-3.gif"//link: "",
},{title:"Stock Financial Model",subtitle:"Python backend with Pandas Dataframe analysis",description:"This program calculates neutral positioning of stock options data in the financial markets that help to determine if a stock price is over or under-valued",image:"./project-4.gif"//link: "",
}];var testimonials=[{quote:"\n"+"I recently had a website built by an incredibly talented team, and I couldn't be happier with the results! The website is not only visually stunning but also highly functional and user-friendly. From the seamless navigation to the engaging content, every aspect of the website reflects the dedication and expertise of the developers. They listened attentively to my ideas and turned them into a reality, exceeding my expectations in every way. I highly recommend their services to anyone looking for a professional and top-notch website!",image:"https://randomuser.me/api/portraits/men/1.jpg",name:"Jesse Hicks",company:"Exclaim Restaurant Management"},{quote:"I had a fantastic experience working with the team that built my website. They were professional, attentive, and extremely skilled at what they do. The website they created for me is not only visually appealing but also optimized for performance across all devices. The attention to detail is evident in every aspect, from the sleek design to the seamless functionality. I'm thrilled with the outcome and would highly recommend their services to anyone looking to elevate their online presence.",image:"https://randomuser.me/api/portraits/men/94.jpg",name:"Ruben Alvarez",company:"Pondfish LLC"}];var skills=["JavaScript","React","Next.js","Node","GraphQL","Material UI"];
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(2),r=__webpack_require__(16);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Testimonials__ = __webpack_require__(264);
...
throw new Error("Module parse failed: Unexpected token (25:24)\nYou may need an appropriate loader to handle this file type.\n|     const blockHeadless = opts.blockHeadless || store.blockHeadless;\n|     const storageProvider = store.storageProvider || opts.storageProvider;\n|     const blockList = { ...store.blockList, ...opts.blockList };\n|     const limitRate = { ...store.limitRate, ...opts.limitRate };\n|     if (blockHeadless && isHeadless(navigator)) {");

/***/ }),
/* 29 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (28:24)\nYou may need an appropriate loader to handle this file type.\n|     const blockHeadless = opts.blockHeadless || store.blockHeadless;\n|     const storageProvider = store.storageProvider || opts.storageProvider;\n|     const blockList = { ...store.blockList, ...opts.blockList };\n|     const limitRate = { ...store.limitRate, ...opts.limitRate };\n|     if (blockHeadless && isHeadless(navigator)) {");
...
function Navbar(){return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("header",{className:"bg-gray-800 md:sticky top-0 z-10"},__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div",{className:"container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center"},__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("a",{className:"title-font font-medium text-white mb-4 md:mb-0"},__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("a",{href:"#about",className:"ml-3 text-xl hover:text-blue-300"},"Jeffrey Scoggins")),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("nav",{className:"md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700\tflex flex-wrap items-center text-white justify-center"},__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("a",{href:"#projects",className:"mr-5 hover:text-blue-300"},"Past Work"),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("a",{href:"#skills",className:"mr-5 hover:text-blue-300"},"Skills"),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("a",{href:"#testimonials",className:"mr-5 hover:text-blue-300"},"Testimonials")),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("a",{href:"#contact",className:"inline-flex items-center bg-gray-700 border-0 py-1 px-3 focus:outline-none hover:bg-blue-300 rounded text-white mt-4 md:mt-0"},"Hire Me",__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0__heroicons_react_solid__["a" /* ArrowRightIcon */],{className:"w-4 h-4 ml-1"}))));}
